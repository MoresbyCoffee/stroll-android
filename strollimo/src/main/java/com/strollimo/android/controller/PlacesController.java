...
public class PlacesController {
    ...
    public PlacesController(Context context) {
        ...
        Mystery lostInTime = new Mystery("1", "Lost in time", 51.504055, -0.019859, "id:1", context.getResources().getDrawable(R.drawable.canary2));
        addMission(lostInTime);
        addMission(new Mystery("2", "The mystery of the Bridge", 51.501757, -0.020514, "id:2", context.getResources().getDrawable(R.drawable.canary3)));
        addMission(new Mystery("3", "The hidden 'Canary'", 51.507040, -0.022413, "id:3", context.getResources().getDrawable(R.drawable.canary4)));
        addMission(new Mystery("4", "Amsterdam", 51.494996, -0.01649, "id:4", context.getResources().getDrawable(R.drawable.dock)));
        addMission(new Mystery("5", "Floating Chinese", 51.49708, -0.016147, "id:5", context.getResources().getDrawable(R.drawable.lotus)));
        addMission(new Mystery("6", "The Golden Egg", 51.505722, -0.027047, "id:6", context.getResources().getDrawable(R.drawable.westferry_circus)));
