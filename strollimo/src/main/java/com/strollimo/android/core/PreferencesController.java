...
public class PreferencesController {
    private static final String TAG = PreferencesController.class.getSimpleName();
    ...
    public PreferencesController(Context context, SharedPreferences prefs, Gson gson) {
        mPrefs = prefs;
        mContext = context;
        mGson = gson;
