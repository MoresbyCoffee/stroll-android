...
/**
 * A singleton to present a simple static interface for Glide {@link com.bumptech.glide.Glide.Request} and to create and manage an
...
public class Glide {
     ...
     * for use with {@link com.bumptech.glide.Glide.Request} and/or as an easily accessible singleton
     *
    ...
    /**
     * Set the {@link RequestQueue} to use with {@link com.bumptech.glide.Glide.Request}. Replaces the current
    ...
    /**
     * Set the {@link ImageManager} to use with {@link com.bumptech.glide.Glide.Request} Replaces the current
     ...
     * </p>
     *
     * @param modelLoader The {@link com.bumptech.glide.Glide.ModelRequest} to use to load an image from a given model
     * @return A {@link com.bumptech.glide.Glide.ModelRequest} to set the specific model to load
     */
     ...
     * @return A {@link com.bumptech.glide.Glide.Request} to set options for the load and ultimately the target to load the model into
     */
