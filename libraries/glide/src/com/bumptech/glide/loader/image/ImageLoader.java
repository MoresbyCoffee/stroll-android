...
public interface ImageLoader {
    ...
    /**
     * An interface defining a callback that will be passed to an {@link com.bumptech.glide.loader.image.ImageLoader} and that should be called by the
     * {@link com.bumptech.glide.loader.image.ImageLoader} when a load completes either successfully or because of an exception
     */
    public interface ImageReadyCallback {
         ...
         * @return True iff the loaded image was used by the class that requested it from the {@link com.bumptech.glide.loader.image.ImageLoader}
         */
